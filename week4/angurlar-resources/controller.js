...
angular.module('confusionApp')
        ...
        .controller('DishDetailController', ['$scope', '$stateParams', 'menuFactory', function($scope, $stateParams, menuFactory) {
           ...
           $scope.dish = menuFactory.dish= menuFactory.getDish(parseInt($stateParams.id,10));
        ...
        .controller('AboutusController', ['$scope','corporateFactory', function($scope, corporateFactory){
